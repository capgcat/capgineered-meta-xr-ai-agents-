...
PROJECT_ID = "hacker2025-team-63-dev"
if not PROJECT_ID:
    raise ValueError(
...
CORPUS_DISPLAY_NAME = "Guidance_Instructions"
CORPUS_DESCRIPTION = "Guidance Instructions corpus"
PDF_URL = "./GuidanceInstructionData.pdf"
PDF_FILENAME = "./GuidanceInstructionData.pdf"
